...
**Date:** 2026-06-12 | **Last updated:** 2026-06-13 | **Status: v1.0.3 installer built, awaiting delivery to aunt** (aunt has v1.0.0; v1.0.1/1.0.2/1.0.3 never sent)
...
- **v1.0.3 installer REBUILT 2026-06-13 16:26** (104.8MB, SHA256 A3DBD155…) at `release/DuckDuckWash Setup 1.0.3.exe` — now includes wearer collapse sections, per-wearer spreadsheet presets, and Reports xlsx export. This is the build to hand to aunt.
